...
primary=asm auto break case const continue default do else enum extern for goto if inline restrict return sizeof static struct switch typedef union volatile while FALSE NULL TRUE
secondary=float int long char sort signed void volatile unsigned double char
